...
namespace MakeDocFromTemplate
{
    public class MainFunctions
    {
        ...
        public void LoadDataFromDbToMemory(out DbData dbData)
        {
            dbData = new DbData();
